...
impl<PORT: PortNum, PIN: PinNum, DIR: ConvertToOutput> PinProxy<PORT, PIN, DIR> {
    /// Configures pin as output
    pub fn to_output(self, _pxdir: &mut Pxdir<PORT::Port>) -> PinProxy<PORT, PIN, Output> {
        make_proxy!()
    }
}

impl<PORT: PortNum, PIN: PinNum, DIR: ConvertToInput> PinProxy<PORT, PIN, DIR> {
    /// Configures pin as output
    pub fn to_input(self, _pxdir: &mut Pxdir<PORT::Port>) -> PinProxy<PORT, PIN, Input<Unknown>> {
        make_proxy!()
    }
}
...
impl<PORT: PortNum, PIN: PinNum, DIR> WritePxdir for PinProxy<PORT, PIN, DIR> {
    ...
    Batch<PORT, DIR0, DIR1, DIR2, DIR3, DIR4, DIR5, DIR6, DIR7>
{
    ...
    /// LOCKLPM5.
    pub fn commit(self, _pmm: &Pmm) -> Parts<PORT, DIR0, DIR1, DIR2, DIR3, DIR4, DIR5, DIR6, DIR7> {
        self.write_regs();
        Parts::new()
    }
}
